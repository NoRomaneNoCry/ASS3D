...
CASpring::CASpring(CAParticle* _p1, CAParticle* _p2, const float _l0, const float _k) 
{ 
	set(_p1,_p2,_l0,_k); 
}

void CASpring::set(CAParticle* _p1, CAParticle* _p2, const float _l0, const float _k)
{
	p1 = _p1;
	p2 = _p2;
	l0 = _l0;
